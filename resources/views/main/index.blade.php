...
@section('content')
    <div class="row">
        ...
        <a href="{{ route('registroPropiedad.create') }}"
            class="btn btn-success btn-menu col-12 col-sm-6 col-md-6 col-lg-3 col-xl-3 p-2">
            Huertas Registradas
        </a>
        ...
        <a href="{{ route('aplicacionFertilizante.create') }}"
            class="btn btn-warning btn-menu col-12 col-sm-12 col-md-4 {{-- col-lg-3 col-xl-3 --}} p-2">
        ...
        <a href="{{ route('controlPreventivo.create') }}"
            class="btn btn-danger btn-menu col-12 col-sm-6 col-md-6 col-lg-4 col-xl-4 p-2">
        ...
        <a href="{{ route('identificacionPlagas.create') }}"
            class="btn btn-danger btn-menu col-12 col-sm-6 col-md-6 col-lg-2 col-xl-2 p-2">
        ...
        <a href="{{ route('calibracionEquipo.create') }}"
            class="btn btn-secondary btn-menu col-12 col-sm-6 col-md-6 col-lg-3 col-xl-3 p-2">
        ...
        <h1 class="col-12 mt-5">Administración y Reportes</h1>

        <a href="{{ route('gasto.create') }}"
            class="btn btn-info btn-menu col-12 col-md-4 col-lg-4 p-2">
            Registro de Gastos
        </a>
